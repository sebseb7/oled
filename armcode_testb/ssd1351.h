...
#define SET_SCK	(LPC_GPIO0->MASKED_ACCESS[(1<<6)] = (1<<6))	
#define CLR_SCK	(LPC_GPIO0->MASKED_ACCESS[(1<<6)] = 0)
#define SET_SID	(LPC_GPIO0->MASKED_ACCESS[(1<<7)] = (1<<7))	
#define CLR_SID	(LPC_GPIO0->MASKED_ACCESS[(1<<7)] = 0)
#define SET_CS	(LPC_GPIO0->MASKED_ACCESS[(1<<8)] = (1<<8))	
#define CLR_CS	(LPC_GPIO0->MASKED_ACCESS[(1<<8)] = 0)
#define SET_DC	(LPC_GPIO0->MASKED_ACCESS[(1<<9)] = (1<<9))	
#define CLR_DC	(LPC_GPIO0->MASKED_ACCESS[(1<<9)] = 0)
#define SET_RST	(LPC_GPIO0->MASKED_ACCESS[(1<<10)] = (1<<10))	
#define CLR_RST	(LPC_GPIO0->MASKED_ACCESS[(1<<10)] = 0)


#ifdef I6800
#define SET_E (LPC_GPIO2->MASKED_ACCESS[(1<<8)] = (1<<8))
#define CLR_E (LPC_GPIO2->MASKED_ACCESS[(1<<8)] = 0)
#define SET_D2 (LPC_GPIO2->MASKED_ACCESS[(1<<3)] = (1<<3))
#define CLR_D2 (LPC_GPIO2->MASKED_ACCESS[(1<<3)] = 0)
#define SET_D3 (LPC_GPIO1->MASKED_ACCESS[(1<<3)] = (1<<3))
#define CLR_D3 (LPC_GPIO1->MASKED_ACCESS[(1<<3)] = 0)
#define SET_D4 (LPC_GPIO1->MASKED_ACCESS[(1<<4)] = (1<<4))
#define CLR_D4 (LPC_GPIO1->MASKED_ACCESS[(1<<4)] = 0)
#define SET_D5 (LPC_GPIO1->MASKED_ACCESS[(1<<5)] = (1<<5))
#define CLR_D5 (LPC_GPIO1->MASKED_ACCESS[(1<<5)] = 0)
#define SET_D6 (LPC_GPIO3->MASKED_ACCESS[(1<<3)] = (1<<3))
#define CLR_D6 (LPC_GPIO3->MASKED_ACCESS[(1<<3)] = 0)
#define SET_D7 (LPC_GPIO2->MASKED_ACCESS[(1<<6)] = (1<<6))
#define CLR_D7 (LPC_GPIO2->MASKED_ACCESS[(1<<6)] = 0)
#endif
