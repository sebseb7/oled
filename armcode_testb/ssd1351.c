...
//	if(byte & 1) SET_SCK;else CLR_SCK;
//	if(byte & 2) SET_SID;else CLR_SID;
//	if(byte & 4) SET_D2;else CLR_D2;
//	if(byte & 8) SET_D3;else CLR_D3;
//	if(byte & 16) SET_D4;else CLR_D4;
//	if(byte & 32) SET_D5;else CLR_D5;
//	if(byte & 64) SET_D6;else CLR_D6;
	if(byte & 128) SET_D7;else CLR_D7;
